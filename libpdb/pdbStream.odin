...
parse_pdb_stream :: proc(this: ^BlocksReader) -> (header: PdbStreamHeader, nameMap: PdbNamedStreamMap, features: []PdbRaw_FeatureSig) {
    ...
    for i in 0..<len(features) {
        features[i] = readv_from_blocks(this, PdbRaw_FeatureSig)
    }
